...
public class Markov {
  ...
  /**
   * Read in counts from a counts file
   * 
   * @param ner_count
  ...
  /**
   * Gives the log probability of a trigram/bigram ratio
   * 
   * @param tagm2
   * @param tagm1
   * @param tag
  ...
  /**
   * Generates a pitable first, then picks the highest "v" tag of each k value.
   * 
   * @param sentence
   * @return
   * @throws NumberFormatException
  ...
  /**
   * Writes the values generated by viterbi for each sentence to a file
   * 
   * @param ner_dev
   * @throws IOException
   */
  ...
  /**
   * Testing method because I screwed up
   */
